...
public class LoginTemplate extends JFrame {
    ...
    public void crearObjetosDecoradores(){
        ...
        iFondo = new ImageIcon("Clase14/resources/img/fondo.png");
        iLogo = new ImageIcon("Clase14/resources/img/logo.png");
        iUsuario = new ImageIcon("Clase14/resources/img/usuario.png");
        iClave = new ImageIcon("Clase14/resources/img/clave.png");
        iPunto = new ImageIcon("Clase14/resources/img/punto.png");
        iFacebook = new ImageIcon("Clase14/resources/img/facebook.png");
        iTwitter = new ImageIcon("Clase14/resources/img/twitter.png");
        iYoutube = new ImageIcon("Clase14/resources/img/youtube.png");
        iSvg = new ImageIcon("Clase14/resources/img/imagen.png");
        iSvg2 = new ImageIcon("Clase14/resources/img/imagen2.png");
        iSvg3 = new ImageIcon("Clase14/resources/img/imagen3.png");
        iPunto2 = new ImageIcon("Clase14/resources/img/punto2.png");
    }
