...
public class NavegacionUsuarioTemplate extends JPanel{
    ...
    public void crearObjetosDecoradores(){
        ...
        this.iIconoUsuario = new ImageIcon("Clase14/resources/img/usuario_navegacion.png");
        this.iInicio = new ImageIcon("Clase14/resources/img/inicio.png");
        this.iPerfil = new ImageIcon("Clase14/resources/img/perfil.png");
        this.iAmigos = new ImageIcon("Clase14/resources/img/amigos.png");
        this.iProductos = new ImageIcon("Clase14/resources/img/productos.png");
        this.iConfiguracion = new ImageIcon("Clase14/resources/img/configuracion.png");
        this.iCerrarSesion = new ImageIcon("Clase14/resources/img/salir.png");
    }
