...
public class InicioTemplate extends JPanel{
    ...
    public void crearObjetosDecoradores(){
        this.iTarjeta1 = new ImageIcon("Clase14/resources/img/tarjeta1.jpg");
        this.iTarjeta2 = new ImageIcon("Clase14/resources/img/tarjeta2.jpg");
        this.iTarjeta3 = new ImageIcon("Clase14/resources/img/tarjeta3.jpg");
        this.iTarjeta4 = new ImageIcon("Clase14/resources/img/tarjeta4.jpg");
        this.iTarjeta5 = new ImageIcon("Clase14/resources/img/tarjeta5.jpg");
        this.iTarjeta6 = new ImageIcon("Clase14/resources/img/tarjeta6.jpg");
        this.iDerecha = new ImageIcon("Clase14/resources/img/derecha.png");
        this.iIzquierda = new ImageIcon("Clase14/resources/img/izquierda.png");
    }
